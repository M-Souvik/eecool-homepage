  ...
  return (
    <div className="flex sm:flex-row  flex-col justify-evenly gap-4 sm:px-20 sm:py-10">
        <div className="flex flex-col bg-white p-4 gap-3 pb-16">
            <Image src="/assets/blog1.jpg" alt="Air Cooler Buying Guide" width={1900} height={1000} className="bg-contain w-full h-full"/>
        ...
        <div className="flex flex-col bg-white p-4 gap-3 pb-16">
            <Image src="/assets/blog2.jpg" width={400} height={400} alt="Air Cooler Tips" className='bg-contain w-full h-full'/>
            <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col bg-white p-4 gap-3 pb-16">
            <Image src="/assets/blog3.jpg" alt="Advantages of Air Coolers" width={500} height={500} className='bg-contain w-full h-full'/>
            <div className="flex flex-col gap-2">
